...
LEADS = [
    {"id": "11111111-1111-1111-1111-111111111111", "created_at": "2026-09-16T10:20:00+00:00",
     ...
     "source": "Вызвать мастера", "page": "https://www.tulyacenterorg.ru/", "status": "new", "utm": "holodok"},
    {"id": "22222222-2222-2222-2222-222222222222", "created_at": "2026-09-15T18:05:00+00:00",
     ...
     "page": "https://www.tulyacenterorg.ru/", "status": "work", "utm": "holodok", "comment": "перезвонить"},
    # старая заявка без тега — опознаётся по словам holodok/tylo в адресе страницы
...
async def main():
    ...
    try:
        async with async_playwright() as p:
            ...
            await pg.fill("#mMsg", "Парогенератор шипит")
